...
/*
 * Documentation:
 * Tree View — https://app.subframe.com/0dfd4f0cae98/library?component=Tree+View_4ed46422-ecc3-41e8-8787-e55ee10cdc75
 */
...
const Folder = React.forwardRef<HTMLElement, FolderProps>(function Folder(
  ...
  return (
    ...
    >
      {children ? (
        <div className="flex w-full flex-col items-start gap-1 px-6 pt-1">
          {children}
        </div>
      ) : null}
    </Accordion>
